...
Route::prefix('v1')->group(function () {
    ...
    Route::middleware(['auth:api'])->group(function () {
        ...
        Route::post('message/alert/{message}', [MessageController::class, 'alertRecieved']);
        Route::delete('messages/delete', [MessageController::class, 'deleteMessages']);
        Route::delete('chat/delete/{sender}', [MessageController::class, 'deleteChats']);
        ...
        Route::put('update_fcm_token', [UserController::class, 'updateFcmToken']);
    });
});